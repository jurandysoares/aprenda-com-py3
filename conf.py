...
project = u'Aprenda Computação com Python 3.0'
...
htmlhelp_basename = 'AprendaComputaocomPy3k'
...
latex_documents = [
  ('index', 'AprendaComputaocomPython3k.tex', ur'Aprenda Computação com Python 3.0',
